...
<a href="EmployeePanel.jsp"><button class="btn btn-primary btn-md" style="background-color: blue; color: white; font-size: 16px;display: block; margin: 0 auto;">Back</button></a>
